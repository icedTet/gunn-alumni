...
export default function Email(props: {
  ...
  return (
    <Html>
      <Head />
      <Preview>Join the Gunn Alumni Network!</Preview>
      <Section style={main}>
        <Container style={container}>
          ...
          <Text style={h1}>
            Join the <strong>Henry M. Gunn</strong> Alumni Network
          </Text>
          <Text style={text}>
            Hello <strong>{name}</strong>,
          </Text>
          <Text style={text}>
            You are just one step away from joining the Gunn Alumni Network!{" "}
